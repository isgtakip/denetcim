...
<v-list-item class="pb-0 mb-0 pb-0 mt-0" >
            <v-list-item-content class="pl-1 mb-0 pb-0">
              ...
              <v-list-item-subtitle>Lokasyon Temel Bilgilerini Giriniz</v-list-item-subtitle>
                <v-container fluid>
  <v-row>
  <v-col
       cols="12"
...
export default {
 ...
 methods:{
      ...mapActions(
        ...
        clickedNaceSave(){
            if (this.$refs.naceKod.secilen_nace_kodu.length>0) this.naceler.splice(0)
            this.naceler.push({
        ...
        handleOptions(options,search){
          let obj ={arama:search,page:options.page,per_page:options.itemsPerPage,firma_tur:1,ust_firma_id:this.ana_firma.firma_id}
          this.loading=true
